...
const CompareButton: React.FC<Props> = ({ product, className }) => {
  ...
  const compareStatus =
    isInCompare === true ? "Browse compares " : "Added to Compares";
    ...
    <Tooltip content={compareStatus} className={"min-w-36"}>
      {isInCompare ? (
        <button
          ...
          className={cn(
            "bg-gray-200 text-gray-600 dark:text-gray-700 px-5 py-3  rounded  w-full flex justify-center  h-full",
            className,
          )}
        >
        ...
        <button
          ...
          className={cn(
            " bg-gray-200 text-gray-600 dark:text-gray-700 px-5 py-3  rounded  w-full flex justify-center  h-full hover:bg-blue-500 hover:text-white",
            className,
