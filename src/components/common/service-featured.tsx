...
const ServiceFeature: React.FC<Props> = ({
  ...
  const data = [
    {
      id: 1,
      icon: <DeliveryIcon color={colorMap[selectedColor].link} />,
      title: "Fast Delivery",
    ...
    {
      id: 2,
      icon: <CardIcon color={colorMap[selectedColor].link} />,
      title: "safe payment",
    ...
    {
      id: 3,
      icon: <FeedbackIcon color={colorMap[selectedColor].link} />,
    ...
    {
      id: 4,
      icon: <SupportIcon color={colorMap[selectedColor].link} />,
      title: "Help Center",
    ...
    {
      id: 5,
      icon: <LicenseIcon color={colorMap[selectedColor].link} />,
      title: "Curated items",
  ...
  return (
    <div
      className={cn(
        "group",
        {
          "border-b border-black/5 py-10 py:mb-12":
            variant === "default" || variant === "home3",
          "featuredCarousel  bg-white rounded p-6 px-8 xl:px-11 ":
            variant === "home2",
          "py-8": variant === "home5",
        },
        className,
