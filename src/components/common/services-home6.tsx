...
const data = [
  {
    id: 1,
    icon: <DeliveryIcon color="text-brand-light" />,
    title: "Fast Delivery",
    description: "Deliver in 24 hours max!",
  },
  {
    id: 2,
    icon: <CardIcon color="text-brand-light" />,
    title: "Safe payment",
    description: "100% secure payment",
  },
  {
    id: 3,
    icon: <SupportIcon color="text-brand-light" />,
    title: "Help Center",
...
const ServicesHome6: React.FC<Props> = ({
    ...
    <div
      className={cn(
        "group",
        {
          ...
          "border-b border-white/10 dark:border-black/10 p-6  xl:py-8 ":
            variant === "home6",
        },
        className,
      )}
