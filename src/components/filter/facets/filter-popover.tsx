...
export function FilterPopover({
  ...
  return (
    <Popover className="relative">
      <PopoverButton
        className={cn(
          "flex items-center justify-between gap-2 px-4 py-2 rounded-full text-sm  transition-colors",
          "border focus:outline-none focus-visible:ring-2 focus-visible:ring-gray-200  hover:border-neutral-500",
          isOpen && `bg-gray-50  ${colorMap[selectedColor].border}`,
          isSelected
            ? `bg-gray-50  ${colorMap[selectedColor].border}`
      ...
      >
        ...
        <div className="px-5 py-4 bg-neutral-50 dark:bg-neutral-900 dark:border-t dark:border-neutral-800 flex items-center justify-between">
          <button
            onClick={() => {
              onClear?.();
            }}
