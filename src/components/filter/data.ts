...
export const categoriesData: CategoryOption[] = [
  ...
  { id: "iphone", label: "iPhone", count: 1 },
  {
    id: "laptop-ipad",
    label: "Laptop & Ipad",
    count: 10,
    subCategories: [
      { id: "macbook", label: "MacBook", count: 5 },
      { id: "ipad-pro", label: "iPad Pro", count: 3 },
      { id: "ipad-air", label: "iPad Air", count: 2 },
    ],
  },
  {
    id: "smart-phones-tablets",
    label: "Smart Phones & Tablets",
    count: 8,
    subCategories: [
      { id: "android", label: "Android", count: 5 },
      { id: "ios", label: "iOS", count: 3 },
    ],
  },
  { id: "unlocked", label: "Unlocked", count: 1 },
];
