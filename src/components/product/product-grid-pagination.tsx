...
import ProductCardList from "@/components/product/cards/product-list";
...
export const ProductGridPagination: FC<ProductGridProps> = ({
  data,
  isLoading,
  className = "",
  viewAs,
    ...
    <>
      {isLoading ? (
        ...
        <div className=" w-full flex flex-col items-center justify-center py-16 lg:py-30 bg-white rounded-md">
          <h2 className="text-xl  font-semibold text-brand-dark mb-10">
