...
const SupperCategoryList: React.FC<Props> = ({
  ...
  return (
    <div
      className={cn(
        "flex items-center block-title mb-1.5 px-3 lg:px-5 py-3 rounded bg-white gap-2 min-h-[48px]",
        className,
      )}
    >
      ...
      <div className="ltabs-tabs-wrap flex flex-wrap justify-end basis-[30%]">
        <ul key="content" className="text-[14px]">
          ...
          >
            <Link href={`${ROUTES.CATEGORIES}/${data?.slug}`}>
              <span className="inline-flex me-1">View More</span>
            </Link>
