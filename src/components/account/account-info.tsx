            ...
            <div className="flex items-center gap-5">
              ...
              <div className="dashboard__main-content">
                <h4 className="text-brand-dark text-xl font-semibold mb-1">
                  Welcome Luhan Nguyen.
                </h4>
                <p className="text-base  mb-0">
                  yourexample@email.com · Los Angeles, CA
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="flex flex-col sm:flex-row -mx-1.5 md:-mx-2.5 space-y-4 sm:space-y-0">
              <div className="w-full sm:w-1/2 px-1.5 md:px-2.5">
                ...
                <Listbox value={selected} onChange={setSelected}>
                  <ListboxButton
                    className={cn(
                      "py-2 px-4 w-full text-left appearance-none relative transition duration-150 ease-in-out border  text-13px lg:text-sm font-body rounded  min-h-11 transition duration-200 ease-in-out ",
                      "focus:ring-0 text-brand-dark border-border-two focus:border-1 focus:outline-none focus:border-gray-400 h-11",
                    )}
                  >
                    {selected.name}
                    <FaCaretDown
                      className="group pointer-events-none absolute top-2.5 right-2.5 size-4 fill-black/60 text-black"
                      aria-hidden="true"
                    />
                  </ListboxButton>
                  <ListboxOptions
