        ...
        <label htmlFor={searchId} className="flex flex-1 items-center py-0.5">
          <input
            ...
            className={cn(
              ...
              {
                "border-2 bg-brand-light dark:bg-gray-800 border-black/10 dark:border-white/10  focus:border-black/50 focus:ring-0 ":
                  variant === "border",
                "bg-brand-light border-2 border-black/10  dark:border-white/15 focus:border-black/50 ":
                  variant === "dark",
              },
            )}
