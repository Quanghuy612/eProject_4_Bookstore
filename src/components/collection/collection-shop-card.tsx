...
const CollectionShopCard: React.FC<Props> = ({
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "absolute flex flex-col px-4 bg-white rounded group",
          colorMap[selectedColor].hoverBg,
          {
            "inset-x-4 bottom-4  ": variant === "default",
            "rounded-full  bottom-7   py-1 max-w-[180px] w-full":
              variant === "rounded-xl",
          },
        )}
      >
        <Heading
          variant="base"
          className={cn(
            "lg:px-5 py-2 leading-7 text-center hover:text-white dark:hover:text-black",
            {
