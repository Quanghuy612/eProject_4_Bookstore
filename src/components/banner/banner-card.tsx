  ...
  return (
    <div className={cn("mx-auto", className)}>
      ...
      >
        ...
        {effectActive && (
          <div className="absolute top-0 block w-1/2 h-full transform -skew-x-12 ltr:-left-full rtl:-right-full z-5 bg-gradient-to-r from-transparent to-white opacity-30 group-hover:animate-banner" />
        )}
      </Link>
    </div>
  );
