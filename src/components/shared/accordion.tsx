        ...
        <Disclosure as="div">
          {({ open }) => (
            <>
              <DisclosureButton
                className={cn(
                  "border-b-1 border-border-base  flex justify-between w-full py-4 text-base text-left  text-brand-dark focus:outline-none ",
              ...
              >
                ...
                {open ? (
                  <FiMinus
                    className={`text-lg ${colorMap[selectedColor].link}`}
                  />
                ) : (
              ...
              {open && (
                <DisclosurePanel transition>
                  <div className="py-3  text-sm leading-7 ">{content}</div>
                </DisclosurePanel>
              )}
            </>
          )}
