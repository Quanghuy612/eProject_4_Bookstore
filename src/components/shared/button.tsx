...
const Button = forwardRef<HTMLButtonElement, ButtonProps>((props, ref) => {
  ...
  const rootClassName = cn(
    "group text-15px leading-4 inline-flex items-center cursor-pointer transition ease-in-out duration-300 font-body font-semibold text-center justify-center tracking-[0.2px] rounded-md placeholder-white focus-visible:outline-none focus:outline-none",
    {
      ...
      "h-12 w-full bg-[#ffc439] hover:bg-[#f0b82d] text-black dark:text-white sm:font-normal tracking-widest px-5 md:px-6 lg:px-8 py-4 md:py-3.5 lg:py-4 ":
        variant === "paypal",
      [`text-base border border-border-two tracking-widest px-5  py-4 md:py-3.5 lg:py-4`]:
        variant === "border",
