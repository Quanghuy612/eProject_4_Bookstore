...
const PageHeroSection: React.FC<HeaderProps> = ({
  ...
  return (
    <div
      className={cn(
        "flex justify-center min-h-[150px] lg:min-h-[200px] w-full bg-slate-200/50 border-b border-border-base page-header-banner",
        {
    ...
    >
      <div className="relative flex flex-col items-center justify-center w-full">
        ...
        >
          <span className="block mb-2 font-bold md:mb-4 ">{heroTitle}</span>
        </h2>
        <Breadcrumb />
      </div>
    </div>
