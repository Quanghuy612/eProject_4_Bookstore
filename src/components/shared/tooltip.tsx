    ...
    >
      ...
      {isVisible && (
        <div
          ...
          ref={tooltipRef}
          className={cn(
            "absolute z-50 px-3 py-1.5 text-13px rounded font-medium capitalize text-white bg-gray-800  max-w-xs min-w-24 text-center",
        ...
        >
          ...
          <div
            className={cn(
              "absolute border-5 border-gray-800",
