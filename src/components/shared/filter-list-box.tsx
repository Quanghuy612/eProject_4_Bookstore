      ...
      {({ open }) => (
        <div className="relative ltr:ml-2 rtl:mr-2 lg:ltr:ml-0 lg:rtl:mr-0 min-w-[160px]">
          ...
          >
            <ListboxOptions
              static
              className="absolute z-20 w-full py-1 mt-3 overflow-auto text-sm rounded-md shadow-lg bg-white max-h-60 ring-1 ring-border-two ring-opacity-5 focus:outline-none"
            >
