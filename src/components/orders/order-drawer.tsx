          ...
          <div className="block">
            ...
            <div className="p-5 md:p-8">
              ...
              <div className="mt-12 ltr:text-right rtl:text-left">
                <span className="py-3 px-5 cursor-pointer inline-block text-[12px] md:text-[14px] text-black font-medium bg-white rounded border border-solid border-[#DEE5EA] ltr:mr-4 rtl:ml-4   hover:border-[#333] transition-all capitalize">
                  Report order
                </span>
                <span
                  onClick={closeDrawer}
