...
import { IoLogoFacebook, IoLogoInstagram, IoLogoTwitter, IoLogoYoutube, IoClose } from "react-icons/io5";
                ...
                {data?.map((menu: any, index: number) => {
                    ...
                    return (
                        <ListMenu
                            ...
                            key={menuName}
                            menuIndex={index}
                            className={cn(dept > 1 && "ltr:pl-4 rtl:pr-4", dept > 2 && "ltr:pl-8 rtl:pr-8")}
                        />
                    );
                })}
            </ul>
