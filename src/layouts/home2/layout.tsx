...
export default function Home2Layout({
  ...
  return (
    <div className="page-type-home2 flex flex-col min-h-screen bg-background">
      {/* Panel Header Layout */}
      {selectedLayout === "Header5" ? (
        <Header5 />
      ) : selectedLayout === "Header6" ? (
        <Header6 />
      ) : selectedLayout === "Header8" ? (
        <Header8 />
      ) : (
        <Header />
      )}
      ...
      {/* Panel - Footer Layout */}
      {selectedFooter === "Footer5" ? (
        <Footer5 showWidgetServices={true} variant={"home5"} />
      ) : selectedFooter === "Footer7" ? (
        <Footer7 />
      ) : selectedFooter === "Footer8" ? (
        <Footer8 variant={"home8"} />
      ) : (
        <Footer />
      )}
      <BottomNavigation />
