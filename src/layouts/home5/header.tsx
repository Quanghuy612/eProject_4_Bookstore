    ...
    <>
      ...
      >
        ...
        >
          ...
          />
          <div className="top-bar text-sm text-brand-light border-b border-white/10 dark:border-black/10">
            <Container className="2xl:max-w-[1700px]">
              <div className="h-11 flex justify-between items-center">
                <Text
                  className={`hidden md:block truncate m-0`}
                  variant={"small"}
                >
            ...
            <Container className="2xl:max-w-[1700px]">
              <div className="flex items-center justify-between  py-2 md:py-4">
                ...
                <Search
                  searchId="top-search"
                  variant={"dark"}
                  className="hidden lg:flex lg:max-w-[450px] xl:max-w-[600px] 2xl:max-w-[1000px] lg:mx-10"
                />
                {/* End of search */}

                <div className="text-brand-light flex text-sm space-x-5 xl:space-x-10 lg:max-w-[33%]">
                  <AuthDropdown />
          ...
          <div
            className={cn(
              "hidden navbar  lg:block  border-b border-white/10 dark:border-black/10",
              colorMap[selectedColor].header,
            )}
          >
            <Container className="2xl:max-w-[1700px]">
              <div className="flex justify-between items-center">
                ...
                <div className="categories-header-button relative  flex-shrink-0 w-52 xl:w-60">
                  <button
                    className="text-brand-light text-sm border-border-base min-h-[48px] focus:outline-none w-full font-semibold py-2 flex items-center"
