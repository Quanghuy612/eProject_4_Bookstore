    ...
    <>
      ...
      >
        ...
        <Input
          ...
          className="w-full"
          inputClassName={cn(
            "ps-10 md:ps-10 pe-10 md:pe-10 2xl:px-11 h-12 rounded-md bg-transparent border-black/10 dark:border-black/10 focus:outline-none focus:drop-shadow-outline text-gray-400",
            {
        ...
        <button
          className={cn(
            ...
            "bg-brand text-sm font-medium text-brand-light md:h-12 py-2 px-10   focus:outline-none focus:drop-shadow-outline  transform  rounded-e-md -ml-1",
          )}
...
const WidgetSubscription: React.FC<Props> = ({ className, variant }) => {
  return (
    ...
    >
      ...
      <Text className="pb-8 text-fill-footer">
        Join 2.000+ subscribers and get a new discount coupon on every Saturday.
      </Text>
