...
export const metadata: Metadata = {
  title: "Home Digital",
  description:
    "Multipurpose E-commerce template built with React, NextJS, TypeScript and Tailwind CSS.",
};
...
export default async function Page() {
  return (
    <>
      ...
      <div className={"bg-zinc-100 dark:bg-zinc-800 py-10 sm:py-14"}>
        <Container>
          <BestDealsFeed className={"navSlider"} />
          <BestSellerFeed className="mb-8 lg:mb-15" />
          <BannerGrid data={gridHero} grid={1} className="mb-8 lg:mb-15" />
          <ListingElectronic variant={"horizontal"} />
          <BannerGrid data={gridHero2} grid={3} className="mb-8 lg:mb-15" />
          <PopularFeed className="mb-8 lg:mb-15" />
          <LatestblogCarousel />
        </Container>
      </div>
    </>
