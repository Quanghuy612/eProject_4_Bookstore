...
export default async function Page() {
  return (
    <>
      <PageHeroSection heroTitle="Faq" className="faq-banner-area" />
      <Container>
            ...
            <div className={"sticky z-10 md:top-16 lg:top-20"}>
              <div className="w-full p-5 bg-gray-200 rounded-md">
                ...
                <div className="flex items-center gap-4">
                  <button className="px-6 py-3 bg-black dark:bg-brand-light text-white font-medium rounded-md">
                    Contact us
                  </button>

                  <a
                    href="#"
                    className="flex items-center text-black font-medium underline"
                  >
